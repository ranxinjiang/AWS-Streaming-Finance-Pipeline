...
| `analysis.ipynb` | Pandas and Matplotlib analysis of the query results |
...
Export the Athena results as CSV and upload it to the notebook. `analysis.ipynb` expects a file named `results.csv`.
